...
const defaultContacts = [
  {
    ...
    phone: "(919) 555-0192",
    email: "ali.raza@icloud.com",
    workEmail: "ali.raza@creativestudio.pk",
    address: "House 12, Gulshan-e-Iqbal, Karachi",
    birthday: "Jan 12",
    notes: "Frontend developer & design buddy."
  },
  {
    id: "magico",
    firstName: "Ayesha",
    ...
    workEmail: "ayesha@creativestudio.pk",
    address: "Flat 4B, DHA Phase 5, Lahore",
    birthday: "Mar 05",
  ...
  },
  {
    ...
    workEmail: "hamza@creativestudio.pk",
    address: "Street 7, F-8, Islamabad",
    birthday: "Jul 19",
    notes: "Backend engineer, cricket fan."
  },
  {
    id: "jay",
    firstName: "Fatima",
    ...
    workEmail: "fatima@creativestudio.pk",
    address: "Road 3, Bahadurabad, Karachi",
    birthday: "Nov 02",
    notes: "Product manager & plant lover."
  },
  {
    id: "sarah",
    firstName: "Bilal",
    ...
    workEmail: "bilal@creativestudio.pk",
    address: "Street 21, Gulberg III, Lahore",
    birthday: "Sep 21",
    notes: "Mobile developer (Flutter)."
  },
  {
    id: "ryan",
    firstName: "Zara",
    ...
    workEmail: "zara@creativestudio.pk",
    address: "House 5, E-11, Islamabad",
    birthday: "May 14",
    notes: "Content writer & storyteller."
  },
  {
    id: "aga",
    firstName: "Zainab",
  ...
  },
  {
    ...
    phone: "(919) 555-0144",
    email: "mariam.s@icloud.com",
    workEmail: "mariam@creativestudio.pk",
    address: "House 9, Clifton Block 4, Karachi",
    birthday: "Oct 08",
    notes: "Graphic designer & artist."
  }
];
    ...
    if (Array.isArray(parsed)) {
      return parsed.map(c => {
        ...
        const canonicalAvatars = {
          ...
          "Mariam Siddiqui": "/icons/owl.png",
          "Ayesha Khan": "/icons/cow-face.png",
          "Bilal Ahmed": "/icons/fox.png",
          "Fatima Noor": "/icons/chicken.png",
          "Zara Malik": "/icons/cow-face.png",
          "Hamza Sheikh": "/icons/chicken.png",
  ...
  const handleSaveContact = (e) => {
    ...
    if (modalMode === "create") {
      const newContact = {
        ...
        firstName,
        lastName,
        avatar: "/icons/panda.png", // default animal avatar
        avatarBg: "bg-blue-100 dark:bg-blue-950/40",
        gradient,
        phone,
        email,
